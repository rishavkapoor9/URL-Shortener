...
function Signup(props) {
    ...
    Axios.defaults.headers = {
      ...
      function submit(event) {
        Axios.post("http://localhost:4000/signup", { username: data.username, password: data.password }).then(() => {
        ...
        <div>
            <main className="form-signin w-100 m-auto text-center" >
                <form>
                    ...
                    <h1 className="h3 mb-3 fw-normal signup-heading">Signup to <strong>URL Shortener</strong></h1>
